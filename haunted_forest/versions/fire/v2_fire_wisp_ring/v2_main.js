...
// // // // // // main.js — Pines + FBM Fog + HUD + Spawner + WASD + Beam + Sanctuaries + DPS + Overlays + Wisps
...
import { WispSystem } from './systems/WispSystem.js';   // <<< NEW
...
function updateDebug(spStats = {}){
  ...
  debugEl.innerHTML =
    ...
    `| Beam: ${beamState}  (Pointer Lock: click canvas, ESC | RMB: AIM | F: power | P:spawn, V:antiPopIn, C:cleanse all, X:nearest, ,/. angle, 9/0 range, Q/E snap, Shift+Q 180°, W: wisps)`;
}
