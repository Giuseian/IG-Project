...
//       // (2) dietro rispetto al forward della camera, con isteresi ed esclusione "troppo vicino"
//       const s = this._forward.x * dx + this._forward.z * dz; // proiezione firmata
//       if (s < -behDist && dist > minBehindRange) {
...
//         }
//       } else {
//         // reset timer se non è più dietro/sufficientemente distante
