...
// // updated con nebbia funziona + step 3 - alberi piccoli 
// // ===== Three.js & controls =====
// import * as THREE from 'https://cdn.jsdelivr.net/npm/three@0.160.0/build/three.module.js';
// import { OrbitControls } from 'https://cdn.jsdelivr.net/npm/three@0.160.0/examples/jsm/controls/OrbitControls.js';
...
// // patch: PRIMA di creare materiali
// THREE.ShaderChunk.fog_pars_vertex = `
// #ifdef USE_FOG
//   varying vec3 vWorldPosition;
// #endif
...
// // hook per aggiungere fogTime e attivare la fog sui materiali
// const _fogShaders = new Set();
// function attachFogTo(root){
//   root.traverse?.((child)=>{
//     const mat = child.material; if(!mat) return;
//     const mats = Array.isArray(mat) ? mat : [mat];
//     mats.forEach(m=>{
//       m.fog = true; // abilita fog per sicurezza
//       const prev = m.onBeforeCompile;
//       m.onBeforeCompile = (shader)=>{
//         prev?.(shader);
//         shader.uniforms.fogTime = { value: 0.0 };
//         _fogShaders.add(shader);
//       };
//       m.needsUpdate = true; // ricompila con l'hook
//     });
//   });
// }
...
//   scene = new THREE.Scene();
//   scene.background = new THREE.Color(0x87a0c0);
//   scene.fog = new THREE.FogExp2(0xDFE9F3, 5e-6); // master density
...
//   // (opzionale) attacca fog ai materiali già presenti (ground, ecc.)
//   attachFogTo(scene);

//   // ====== FORESTA: SOLO PINI ======
//   await setupForest(scene);

//   // Ora che gli InstancedMesh esistono, aggancia la fog anche a loro
//   attachFogTo(scene);
...
//   // Carica il pino con MTL (la tua TreeCatalog ora supporta mtlUrl)
//   await catalog.load('pine', '/assets/textures/trees/pine.obj', {
//     mtlUrl: '/assets/textures/trees/pine.mtl',
//     scale: 1.0,
//     defaultColor: 0x2e7d32
//   });

//   // Crea la foresta con ForestSystem (già aggiornato con sizePad + SpatialHash coerente)
...
//     types: [
//       { name: 'pine', url: '/assets/textures/trees/pine.obj', occluderHeight: 140, occluderRadiusScale: 0.42 }
//     ],
//   }, catalog);
...
// main.js — Pines only, Pipeline B (rules), Fog FBM
