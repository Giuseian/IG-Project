...
// // // STEP 9: Beam + LOS + Overheat + FORESTA/LOS blocking   - passato troppo prompt a chat 
// // import * as THREE from 'https://cdn.jsdelivr.net/npm/three@0.160.0/build/three.module.js';
// // import { OrbitControls } from 'https://cdn.jsdelivr.net/npm/three@0.160.0/examples/jsm/controls/OrbitControls.js';
// // import { initHUD } from './ui/hud.js';
// // import { GhostSpawner } from './systems/GhostSpawner.js';
...
// // // ---------- Regole PBR per il pino (colori semplici) ----------
// // const PINE_RULES = [
// //   { // CHIOMA
// //     name:'leaves',
// //     matchObj:['leaves','leaf','ico','pine'],
// //     matchMat:['材质.001'],
// //     color:'#7FA36B', roughness:0.95, metalness:0.0, flatShading:true,
// //     emissiveScale:0.5, emissiveIntensity:0.08
// //   },
// //   { // TRONCO
// //     name:'trunk',
// //     matchObj:['trunk','cylinder'],
// //     matchMat:['材质'],
// //     color:'#B28C72', roughness:0.95, metalness:0.0, flatShading:true,
// //     emissiveScale:0.5, emissiveIntensity:0.08
// //   },
// //   { name:'other', color:'#BFBFBF', roughness:0.95, metalness:0.0, flatShading:true }
// // ];
// // const PINE_OPTIONS = {
// //   // mtlUrl non usato dal nostro loader, lasciamo solo regole/scala
// //   keepSourceMaps: false,
// //   scale: 18,
// //   rules: PINE_RULES
// // };
...
// //   // Ground
// //   ground = new THREE.Mesh(
// //     new THREE.PlaneGeometry(2000, 2000), // più grande per ospitare la foresta visiva
// //     new THREE.MeshStandardMaterial({ color: 0x6b5b53, roughness: 1 })
// //   );
// //   ground.rotation.x = -Math.PI/2;
// //   ground.position.y = -0.10;
...
// //   // 2) genero foresta in un anello (con radura attorno al target)
// //   const forest = new ForestSystem(scene, {
// //     seed: 2025,
// //     innerRadius: 40,       // radura interna
// //     outerRadius: 480,      // “muro” di pini fuori dal cerchio di gioco
// //     minSpacing: 22,
// //     maxSpacing: 34,
// //     count: 1200,           // puoi alzare/abbassare
// //     scale: [0.9, 1.35],
// //     clearings: [{ x: FIX_X, z: FIX_Z, r: 18 }],
// //     types: [{
// //       name: 'pine',
// //       url: '/assets/models/trees/pine.obj',
// //       options: PINE_OPTIONS,
// //       occluderHeight: 22,         // altezza cilindro di occlusione (m)
// //       occluderRadiusScale: 0.9    // ~ raggio chioma * scala
// //     }]
// //   }, catalog);

// //   const forestRes = await forest.generate();
// //   // 3) creo un InstancedMesh di cilindri invisibili per i RAYCAST
// //   occluderMesh = buildOccluderInstanced(forestRes.occluders, ground.position.y);
// //   scene.add(occluderMesh);

// //   // HUD debug opzionale: premi H per visualizzare gli occluder
// //   window.addEventListener('keydown', (e)=>{
// //     if (e.key.toLowerCase() === 'h' && occluderMesh?.material) {
// //       const m = occluderMesh.material;
// //       m.opacity = (m.opacity > 0 ? 0.0 : 0.12);
// //       m.transparent = true;
// //       m.depthWrite = false;
// //       m.wireframe = (m.opacity > 0);
// //       m.needsUpdate = true;
// //       console.log('[occluders] visible =', m.opacity > 0);
// //     }
// //   });
...
// //   // bilanciamento esposizione lato ghost
// //   for (const g of spawner.pool) g.params.exposureFalloff = 0.35;
...
// //   // >>> LOS: passiamo i soli occluder (1 InstancedMesh)
// //   beam.setObstacles([ occluderMesh ]);
...
// //   addEventListener('resize', onResize);
// //   Object.assign(window, { spawner, targetPoint, renderer, scene, camera, beam, occluderMesh });
// // }

// // // === helper: costruisce 1 InstancedMesh di cilindri “invisibili” per i raycast ===
// // function buildOccluderInstanced(occs, baseY=0){
// //   if (!occs || !occs.length) return new THREE.Group(); // fallback safe

// //   // cilindro unitario: r=1, h=1; poi scalato per istanza
// //   const geom = new THREE.CylinderGeometry(1, 1, 1, 12, 1, true);
// //   const mat  = new THREE.MeshBasicMaterial({
// //     color: 0x224433, transparent:true, opacity:0.0, depthWrite:false
// //   });
// //   const imesh = new THREE.InstancedMesh(geom, mat, occs.length);
// //   imesh.name = 'OccludersCylinderInstanced';
// //   imesh.frustumCulled = false; // non necessario al raycast, ma è ok
...
// //     const o = occs[i];
// //     // posiziono al centro del cilindro (baseY + h/2)
// //     const px = o.pos.x, pz = o.pos.z;
// //     const h  = o.height;
// //     const r  = o.radius;
// //     m.compose(new THREE.Vector3(px, baseY + h*0.5, pz), q.identity(), s.set(r, h, r));
...
// // function onPointerDown(e){
// //   // LMB = sposta target (se unlocked), RMB = beam
// //   if (isLocked) return;
// //   if (e.button !== 0) return;
...
// //   const fov = camera.fov * Math.PI / 180;
// //   const dist = r / Math.sin(fov * 0.5);
// //   camera.position.set(targetPoint.x, Math.max(6, 0.6*r), targetPoint.z + dist);
// //   controls.target.set(targetPoint.x, 0.6, targetPoint.z);
// //   controls.update();
// // }
...
// //   }
// //   _savedCam = { pos: camera.position.clone(), target: controls.target.clone(), rotate: controls.enableRotate };
// //   camera.position.set(targetPoint.x, 80, targetPoint.z);
// //   controls.target.set(targetPoint.x, 0, targetPoint.z);
// //   controls.enableRotate = false;
// //   controls.update();
// // }
...
// //   // HUD
// //   const lead = spawner?.firstActive?.();
// //   hud?.set(1, beam?.heat ?? 0, 0, { overheated: !!(beam?.overheated) });
// //   hud?.setDebug({
// //     state: lead?.state ?? 'none',
// //     threshold: lead?._getThreshold ? lead._getThreshold() : 1,
// //     exposure: lead?.exposure ?? 0,
...
// // // main.js — Pines + FBM Fog + HUD + Beam Heat placeholder
// // import * as THREE from 'https://cdn.jsdelivr.net/npm/three@0.160.0/build/three.module.js';
// // import { OrbitControls } from 'https://cdn.jsdelivr.net/npm/three@0.160.0/examples/jsm/controls/OrbitControls.js';
...
// //   p0*=norm.x; p1*=norm.y; p2*=norm.z; p3*=norm.w;
// //   vec4 m=max(0.5-vec4(dot(x0,x0),dot(x1,x1),dot(x2,x2),dot(x3,x3)),0.0); m=m*m;
// //   return 105.0*dot(m*m,vec4(dot(p0,x0),dot(p1,x1),dot(p2,x2),dot(p3,p3)));
// // }
// // float FBM(vec3 p){ float v=0.0,a=0.5; for(int i=0;i<6;i++){ v+=a*snoise(p); p*=2.0; a*=0.5; } return v; }
// // `;
// // THREE.ShaderChunk.fog_pars_vertex = `
...
// // import { ForestSystem } from './systems/ForestSystem.js';
// // import { initHUD } from './ui/hud.js';
// // import { Ghost } from './entities/Ghost.js'; // (1) AGGIUNTO
...
// //   // -------------------- GHOST (minimo indispensabile) --------------------
// //   ghost = await new Ghost({
// //     url: '/assets/models/ghost/ghost.glb',
// //     targetHeight: 6.0,   // scala, modifica pure
// //     opacityBody: 0.78,
// //     getGroundY: () => 0.0,
// //     getTargetPos: null,  // nessun target → resta fermo
// //     speed: 0
// //   }).load();

// //   ghost.addTo(scene);
// //   ghost.setPosition(0, 0, 0);  // centro radura
// //   attachFogTo(ghost.root);     // passa fogTime anche ai suoi materiali
// //   renderer.compile(scene, camera);
// //   ghost.setDebugMode(0);
// //   ghost.appear();              // avvia FSM (appearing → active)
// //   // ----------------------------------------------------------------------
...
// // let ghostArrow, seekLine, seekLineGeom, seekStrip, seekStripGeom;
// // let labelGhost, labelTarget;
// // let _t = performance.now() * 0.001;   // Da capire come definirlo 
...
// // // main.js — Pines + FBM Fog + HUD + Beam Heat placeholder  - THIS IS SOMETHING 
// // import * as THREE from 'https://cdn.jsdelivr.net/npm/three@0.160.0/build/three.module.js';
// // import { OrbitControls } from 'https://cdn.jsdelivr.net/npm/three@0.160.0/examples/jsm/controls/OrbitControls.js';
...
// // // main.js — Pines + FBM Fog + HUD + Beam Heat placeholder + Ghost (stati + HUD) 
// // import * as THREE from 'https://cdn.jsdelivr.net/npm/three@0.160.0/build/three.module.js';
// // import { OrbitControls } from 'https://cdn.jsdelivr.net/npm/three@0.160.0/examples/jsm/controls/OrbitControls.js';
...
// // import { ForestSystem } from './systems/ForestSystem.js';
// // import { initHUD } from './ui/hud.js';
// // import { Ghost } from './entities/Ghost.js'; // ← AGGIUNTO
...
// //   // ---------------- GHOST (stati + scala ≈ metà albero) ----------------
// //   ghost = await new Ghost({
// //     url: '/assets/models/ghost/ghost.glb',
// //     targetHeight: env.pineTypicalHeight * 0.50,  // ≈ metà altezza albero
// //     opacityBody: 0.78,
// //     getGroundY: (x, z) => 0.0,
// //     getTargetPos: null,    // nessun target → resta fermo
// //     speed: 0,
...
// //   ghost.addTo(scene);
// //   ghost.setPosition(0, 0, 0); // centro della radura
// //   ghost.appear();             // trigger stati (appearing → active)
...
// //   }
// //   // Scala media usata dal sistema foresta
...
// //   // --- Ghost: update + HUD riga "Ghost"
// //   if (ghost) {
// //     ghost.update(dt);

// //     const thr  = ghost._getThreshold ? ghost._getThreshold() : 1.0;
// //     const dist = Math.hypot(
// //       ghost.root.position.x - camera.position.x,
...
// // main.js — Pines + FBM Fog + HUD + Beam Heat placeholder + Ghost (stati + HUD + look pulito in active) - pilito in active 
// // import * as THREE from 'https://cdn.jsdelivr.net/npm/three@0.160.0/build/three.module.js';
// // import { OrbitControls } from 'https://cdn.jsdelivr.net/npm/three@0.160.0/examples/jsm/controls/OrbitControls.js';
...
// //   addEventListener('mouseup',   (e)=>{ if (e.button === 0) player.beamOn = false; });
// //   addEventListener('keydown',   (e)=>{
// //     if (e.key.toLowerCase() === 'f') { if (!player.overheated) player.beamOn = !player.beamOn; }
// //   });
...
// //   ghost.addTo(scene);
// //   ghost.setPosition(0, 0, 0); // centro della radura
// //   ghost.setDebugMode(0);      // niente viste di debug
// //   // valori di base del materiale
// //   ghost.uniformSets?.forEach(u=>{
// //     if (u.uNoiseScale) u.uNoiseScale.value = 0.25;
// //     if (u.uEdgeWidth)  u.uEdgeWidth.value  = 0.06;
// //   });
// //   ghost.appear();             // trigger stati (appearing → active)
...
// //   // Fog anim (identica al main originale)
// //   _fogShaders.forEach(s => { s.uniforms.fogTime.value = animateFog ? tNow : 0.0; });
...
// //   // --- Ghost: update + HUD + "look pulito" in active
// //   if (ghost) {
// //     ghost.update(dt);

// //     // smoothing verso un aspetto meno rumoroso quando è ACTIVE
// //     if (ghost.state === 'active') {
// //       ghost.uniformSets?.forEach(u=>{
// //         if (u.uThreshold)  u.uThreshold.value  = THREE.MathUtils.damp(u.uThreshold.value, 0.04, 4.0, dt);
// //         if (u.uNoiseScale) u.uNoiseScale.value = THREE.MathUtils.damp(u.uNoiseScale.value, 0.18, 2.5, dt);
// //         if (u.uEdgeWidth)  u.uEdgeWidth.value  = THREE.MathUtils.damp(u.uEdgeWidth.value, 0.06, 6.0, dt);
// //       });
// //     }
...
// // // main.js — Pines + FBM Fog + HUD + Beam Heat + Ghost (stati + HUD + tuning look)
// // import * as THREE from 'https://cdn.jsdelivr.net/npm/three@0.160.0/build/three.module.js';
// // import { OrbitControls } from 'https://cdn.jsdelivr.net/npm/three@0.160.0/examples/jsm/controls/OrbitControls.js';
...
// //   ghost = await new Ghost({
// //     url: '/assets/models/ghost/ghost.glb',
// //     targetHeight: env.pineTypicalHeight * 0.50,  // ≈ metà albero
// //     opacityBody: 0.78,
// //     getGroundY: (x, z) => 0.0,
// //     getTargetPos: null,    // nessun target → fermo
// //     speed: 0,
// //     keepDistance: 0.0,
// //     arriveRadius: 1.0
// //   }).load();
...
// //   ghost.appear();               // trigger FSM

// //   // Tuning “anti-sale&pepe” (pattern più grande + bordo un po’ più spesso)
// //   tuneGhostLook();
...
// //   for (const s of sets){
// //     if (s.uNoiseScale) s.uNoiseScale.value = 0.18;       // pattern più largo
// //     if (s.uEdgeWidth)  s.uEdgeWidth.value  = 0.065;      // bordo un filo più spesso
// //     if (s.uFlowSpeed)  s.uFlowSpeed.value  = 0.12;       // “respiro” lento
// //     if (s.uPulseTime)  s.uPulseTime.value  = 0.0;        // sync start
// //     if (s.uThreshold)  s.uThreshold.value  = 0.06;       // livello "active" morbido
// //     if (s.uEdgeColor){
// //       const c = s.uEdgeColor.value instanceof THREE.Color ? s.uEdgeColor.value : (s.uEdgeColor.value = new THREE.Color());
// //       c.set('#eaf6ff');                                   // rim chiaro “vetroso”
// //     }
// //   }
// // }
...
// // main.js — Pines + FBM Fog + HUD + Beam Heat + Ghost (stati + HUD + tuning look)   - start 
// import * as THREE from 'https://cdn.jsdelivr.net/npm/three@0.160.0/build/three.module.js';
// import { OrbitControls } from 'https://cdn.jsdelivr.net/npm/three@0.160.0/examples/jsm/controls/OrbitControls.js';
...
// main.js — Pines + FBM Fog + HUD + Beam Heat + Ghost SPAWNER (graduale)   - start
import * as THREE from 'https://cdn.jsdelivr.net/npm/three@0.160.0/build/three.module.js';
import { OrbitControls } from 'https://cdn.jsdelivr.net/npm/three@0.160.0/examples/jsm/controls/OrbitControls.js';
...
async function init(){
  ...
  addEventListener('keydown',   (e)=>{
    const k = e.key;
    if (k.toLowerCase() === 'f' && !player.overheated) player.beamOn = !player.beamOn;
    if (k === 'p' || k === 'P') spawner?.forceSpawnNow?.();      // spawn immediato
    if (k === 'v' || k === 'V') spawner?.toggleAntiPopIn?.();    // toggle anti pop-in
  });
  ...
  const getGroundY = (x, z) => 0.0; // terreno piatto (se poi campioni l'altezza, sostituisci qui)
  ...
  spawner = new GhostSpawner({
    ...
    getGroundY,
    getFocusPos,
    attachFog: (node) => attachFogTo(node),
    poolSize: 12,
    maxAlive: 4,
    spawnInterval: 1.0,
    // anello di spawn coerente con la tua scala (player al centro)
    minR: 80,
    maxR: 140,
    minPlayerDist: 45,
    minSeparation: 35,
  ...
  await spawner.init();
  // opzionale: spawna il primo subito
...
function animate(){
  ...
  // Spawner (gestisce anche update dei ghost attivi)
  spawner?.update(dt);
...
function updateDebug(spStats = {}){
  ...
  debugEl.innerHTML =
    ...
    `Heat: ${player.overheated?'<span style="color:#ff6b6b">'+heatPct+'%</span>':heatPct+'%'}  ` +
    `| Beam: ${beamState}  (Mouse L o F | P:force spawn, V:antiPopIn)`;
}
